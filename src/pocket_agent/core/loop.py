...
from pocket_agent.inference.base import InferenceBackend, Message
from pocket_agent.memory.conversation import ConversationMemory
from pocket_agent.memory.structured import StructuredMemory, EXTRACT_PROMPT, parse_extraction
from pocket_agent.memory.plans import (
    PlanMemory, PLAN_INSTRUCTIONS, format_plans_for_context, extract_plans_from_reply,
)
from pocket_agent.tools.base import (
...
from pocket_agent.core.evaluator import evaluate_response, check_date_claims, check_capability_claims
...
from pocket_agent.cursor.runner import parse_cursor_task
from pocket_agent.core.router import route_fast
from pocket_agent.core.tracing import Tracer, NullTurnTrace
...
class AgentLoop:
    ...
    async def _maybe_summarize(self, user_id: str) -> None:
        ...
        from pocket_agent.memory.conversation import SUMMARIZE_PROMPT
